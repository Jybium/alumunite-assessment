...
const UserTable: React.FC<Props> = ({ users }) => (
  <table className="min-w-full overflow-auto bg-white">
    <thead>
      <tr>
        ...
        <th className="px-6 py-3 border-b-2 border-gray-300 text-center leading-4 text-blue-500 tracking-wider">Profile Photo</th>
      </tr>
    </thead>
    <tbody>
      {users.map((user) => (
